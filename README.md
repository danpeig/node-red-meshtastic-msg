...
The [fundamentals_meshtastic_web.mjs](fundamentals_meshtastic_web.mjs) illustrates how to use [Meshtastic Web](https://github.com/meshtastic/web) library from plain NodeJS Javascript (No TypeScript, no React, no compilation, no nothing).
